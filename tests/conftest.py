...
_translator.load_domain("plg_robots", _PLUGIN_SRC_DIR / "plg_robots" / "i18n")

from jinja2 import FileSystemLoader  # noqa: E402
from src.core.templates import admin_templates  # noqa: E402

_TEMPLATES_DIR = _PLUGIN_SRC_DIR / "plg_robots" / "templates"
if not any(
...
from src.plugins.plg_robots import admin as _robots_admin  # noqa: E402
from src.plugins.plg_robots import web as _robots_web  # noqa: E402

if not any(
    getattr(r, "path", "").startswith("/admin/plg_robots")
    for r in _cms_app.routes
):
    _cms_app.include_router(_robots_admin.router)

if not any(
    getattr(r, "path", "") == "/robots.txt"
    for r in _cms_app.routes
):
    _cms_app.include_router(_robots_web.router)
